...
function CreateOffer() {
  // when implementing backend, the trip information will be passes in as tripInfo
  // change useState(''); to useState(tripInfo.date);
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    fetch('http://localhost:5000/trip/offer', {
      method: 'POST',
      body: JSON.stringify({
        from: from, to: to, date: date, startTime: startTime, type: "offer",
    ...
    <ThemeProvider>
      ...
      <div >
        ...
        <div className='createOffer'>
          ...
          <div className='createOfferContent'>
